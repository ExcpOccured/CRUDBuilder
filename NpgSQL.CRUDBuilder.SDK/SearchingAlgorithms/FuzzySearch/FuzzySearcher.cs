...
using System.Linq;
using NpgSQL.CRUDBuilder.SDK.SearchingAlgorithms.FuzzySearch.Automat;
using NpgSQL.CRUDBuilder.SDK.SearchingAlgorithms.FuzzySearch.Models;
using NpgSQL.CRUDBuilder.SDK.SearchingAlgorithms.FuzzySearch.TrieDataStructure;

namespace NpgSQL.CRUDBuilder.SDK.SearchingAlgorithms.FuzzySearch
{
    /// <summary>
